...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		} else if (statement.indexOf("Jacob") >= 0 || statement.indexOf("Jacob") >= 0) {
			response = "Yes, Jacob is a mank meme.";
		} else if (statement.indexOf("Jason") >= 0 || statement.indexOf("jason") >= 0) {
			response = "Jason... wait who is Jason... you probly spelled Jacob wrong lol";
	...
	private String getRandomResponse()
	{
		...
		{
			 response = "The STALION is a stalion lol.";
		}
